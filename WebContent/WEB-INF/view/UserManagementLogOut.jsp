...
<body>	
	...
	<div id="subMenuBar">
		<a href="userManagementLog.action">로그인</a>
		<a href="userManagementLogOut.action" style="background-color: gray; color: white; border-radius: 5px;">로그아웃</a>
		<hr>
	</div>
	<br />
		...
		<!-- 닉네임 클릭 시 해당 유저 프로필 확인 -->
			<table class="table userList">
				...
				<c:if test="${not empty user.logOutRecNo }">
					<tr>
						<td>${user.logOutRecNo }</td>
						<td>${user.pinNo }</td>
